...
const ModuleDetail = () => {
  ...
  if (loading) return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '70vh', gap: 16 }}>
      <div style={{ width: 32, height: 32, borderRadius: '50%', border: '2px solid var(--color-border-subtle)', borderTopColor: 'var(--color-brand-primary)', animation: 'spin 0.6s linear infinite' }} />
      <p style={{ color: 'var(--color-text-secondary)', fontWeight: 600, fontSize: '0.875rem' }}>Loading module details…</p>
  ...
  if (!module) return (
    <div style={{ textAlign: 'center', padding: '10rem 2rem' }}>
      <p style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: 24, color: 'var(--color-text-primary)' }}>Module not found</p>
    ...
    >
      ...
      <div data-detail-grid style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '3rem', alignItems: 'start' }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', fontSize: '0.85rem', fontWeight: 600, color: '#6B7280' }}>
              <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <User size={15} />
                <span style={{ color: 'var(--color-text-primary)', fontFamily: 'monospace' }}>{module.seller}</span>
              </span>
              <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {/* ── Tabs ── */}
          <div style={{ display: 'flex', borderBottom: '1px solid var(--color-border-subtle)', marginBottom: '2rem', gap: 8 }}>
            {TABS.map(tab => (
              <button
                key={tab}
            ...
            >
              {activeTab === 'Overview' ? (
                  ...
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <span style={{ fontSize: '0.75rem', fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--color-text-secondary)' }}>
                          Module Interface
                        </span>
                      </div>
                      <button
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '6rem 2rem', gap: 16 }}>
                  <Package size={48} style={{ color: 'var(--color-border-subtle)' }} />
                  <p style={{ fontSize: '0.75rem', fontWeight: 800, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--color-text-muted)' }}>
                    Data Coming Soon
                  </p>
                </div>
              )}
        ...
        <div style={{ position: 'sticky', top: 96 }}>
          <div className="card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
            ...
            <div style={{ paddingBottom: '1.5rem', borderBottom: '1px solid #1F2933' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                <span style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--color-text-primary)', lineHeight: 1 }}>
                  {module.price}
                </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'var(--color-border-subtle)'; e.currentTarget.style.borderColor = 'var(--color-text-secondary)'; }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${liked ? 'rgba(239, 68, 68, 0.2)' : 'var(--color-border-subtle)'}`,
                  fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer',
                  transition: 'all 0.2s',
                }}
              >
          ...
          <div style={{
            ...
            <div>
              <p style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--color-text-primary)', marginBottom: 2 }}>Secure Purchase</p>
              <p style={{ fontSize: '0.75rem', color: 'var(--color-text-secondary)', lineHeight: 1.4 }}>Verification complete. Listing is authentic.</p>
            </div>
          </div>
        </div>
      </div>

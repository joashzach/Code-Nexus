...
<<<<<<< HEAD
          ...
          <h1 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', fontWeight: 900, letterSpacing: '-0.04em', color: 'var(--color-text-primary)', marginBottom: '0.75rem', lineHeight: 1.1, display: 'block' }}>
